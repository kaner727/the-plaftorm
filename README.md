...
Small note: The code was originally written in Brazillian Portuguese (variable names, html files, etc). I did use GPT-6 Astra to translate all instances and remove some of my old not necessary themes. The rest of the code was (almost) entirely manually written. 
